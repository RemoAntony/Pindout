...
public class categoryGrocery extends ActionBarActivity {
    LinearLayout instoremain;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_category_grocery);
        Toolbar toolbar = (Toolbar) findViewById(R.id.catgrotool);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        instoremain=(LinearLayout)findViewById(R.id.grocerymain);
    ...
    class GetTaggedDeal extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(categoryGrocery.this);
        ...
        protected String doInBackground(String... args) {
            ...
            params.add(new BasicNameValuePair("category_id", "36"));
                ...
                for(int  i=0;i<products.length();i++){
                    ...
                    v.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            {
                                Toast.makeText(categoryGrocery.this, "Local Business Deal", Toast.LENGTH_LONG).show();
                                return;
                            }
                            TextView correcturl=(TextView) view.findViewById(R.id.correcturl);
                            Intent intent=new Intent(categoryGrocery.this, DisplayDealUrl.class);
                            intent.putExtra("urlofdeal",correcturl.getText().toString());
                            startActivity(intent);
                        }
                    });
                }
                if(products.length()==0) Toast.makeText(categoryGrocery.this,"No Deals to display",Toast.LENGTH_LONG).show();

            }catch (Exception e){
                Toast.makeText(categoryGrocery.this,"No Deals to display",Toast.LENGTH_LONG).show();
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //getMenuInflater().inflate(R.menu.menu_category_grocery, menu);
        return true;
    }
