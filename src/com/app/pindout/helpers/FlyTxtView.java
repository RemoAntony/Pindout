...
public class FlyTxtView extends ViewGroup {
	...
	public void init() {
		...
		layoutAnimationController = new LayoutAnimationController(animationSet,
				0.3f);
	...
	protected void onLayout(boolean changed, int left, int top, int right,
		...
		// Log.d(TAG, "changed = " + changed + " left = " + left + " top = " +
		// top + " right = " + right + " botom = " + bottom);
	...
	private void setDefaultAnimation() {
		...
		animationSet.addAnimation(animation);
		animation = new TranslateAnimation(Animation.RELATIVE_TO_PARENT, 1,
