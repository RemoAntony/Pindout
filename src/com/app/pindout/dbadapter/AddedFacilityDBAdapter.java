...
public class AddedFacilityDBAdapter {
	...
	public static final String DATABASE_NAME = "AddedFacility.db";
	static final String DATABASE_TABLE = "addedfacility";
	static final int DATABASE_VERSION = 1;

	static final String DATABASE_CREATE = "create table addedfacility (_id integer primary key autoincrement, "
	...
	public AddedFacilityDBAdapter(Context ctx) {
		this.context = ctx;
	...
	public AddedFacilityDBAdapter open() throws SQLException {
	...
	public long insert(String catid, String catname, String catfacid,
			String fac_name) {
		ContentValues initialValues = new ContentValues();
		initialValues.put(KEY_CATEGORYID, catid);
		initialValues.put(KEY_CATEGORYNAME, catname);
		initialValues.put(KEY_CATFACIDS, catfacid);
	...
	public void delete_by_cat_n_fac_name(String catname, String fac_name)
			throws SQLException {
