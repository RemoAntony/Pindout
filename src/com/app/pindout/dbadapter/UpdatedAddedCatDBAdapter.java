...
public class UpdatedAddedCatDBAdapter {
	...
	public static final String DATABASE_NAME = "UpdatedAddedCategory.db";
	static final String DATABASE_TABLE = "updatedaddedcategory";
	static final int DATABASE_VERSION = 1;

	static final String DATABASE_CREATE = "create table updatedaddedcategory (_id integer primary key autoincrement, "
	...
	public UpdatedAddedCatDBAdapter(Context ctx) {
		this.context = ctx;
	...
	public UpdatedAddedCatDBAdapter open() throws SQLException {
