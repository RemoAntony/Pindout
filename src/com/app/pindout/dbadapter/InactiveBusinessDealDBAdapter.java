...
public class InactiveBusinessDealDBAdapter {
	...
	public static final String DATABASE_NAME = "InActiveBusinessDeal.db";
	static final String DATABASE_TABLE = "businessdeal";
	static final int DATABASE_VERSION = 1;

	static final String DATABASE_CREATE = "create table businessdeal (_id integer primary key autoincrement, "
			+ "row_id text not null, dealname text not null, catid text not null,main_price text not null,deal_price text not null,deal_desc text not null,img_url text not null);";
	...
	public InactiveBusinessDealDBAdapter(Context ctx) {
		this.context = ctx;
	...
	public InactiveBusinessDealDBAdapter open() throws SQLException {
	...
	public long insert(String rowid, String dealname, String catname,
					   String main_price, String deal_price, String deal_desc,
					   String img_url) {
		ContentValues initialValues = new ContentValues();
		initialValues.put(KEY_DEAL_ID, rowid);
	...
	public Cursor get(long rowId) throws SQLException {
		Cursor mCursor = db.query(true, DATABASE_TABLE, new String[] {
						...
						KEY_MAINPRICE, KEY_DEALPRICE, KEY_DEALDESC, KEY_IMAGEURL },
	...
	public boolean update(long rowId, String row_id, String dealname,
						  String catname, String main_price, String deal_price,
						  String deal_desc, String img_url) {
		ContentValues args = new ContentValues();
		args.put(KEY_DEAL_ID, row_id);
