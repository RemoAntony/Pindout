...
public class ActiveBusinessDealDBAdapter {
	...
	public static final String DATABASE_NAME = "ActiveBusinessDeal.db";
	...
	public ActiveBusinessDealDBAdapter(Context ctx) {
		this.context = ctx;
	...
	public ActiveBusinessDealDBAdapter open() throws SQLException {
