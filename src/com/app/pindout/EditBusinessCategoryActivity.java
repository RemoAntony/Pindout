...
public class EditBusinessCategoryActivity extends AppCompatActivity {
	...
	class LoadAllFacilities extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(EditBusinessCategoryActivity.this);
	...
	class LoadAllCategories extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String file_url) {
			...
			pDialog.dismiss();
			adapter = new SimpleAdapter(EditBusinessCategoryActivity.this,
			...
			searchCategory.addTextChangedListener(new TextWatcher() {
				...
				public void onTextChanged(CharSequence cs, int arg1, int arg2,
						int arg3) {
					((SimpleAdapter) EditBusinessCategoryActivity.this.adapter)
							.getFilter().filter(cs);
				}
		...
		protected void onPostExecute(String result) {
			...
			if (is_catexist) {
				...
				if (!catfacid.equals("0")) {
					Intent i = new Intent(EditBusinessCategoryActivity.this,
