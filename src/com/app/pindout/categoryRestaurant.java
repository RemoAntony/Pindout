...
public class categoryRestaurant extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.catresttool);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        instoremain=(LinearLayout)findViewById(R.id.restaurantmain);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_category_restaurant, menu);
        return true;
    }
    ...
    public void predealssearch(View view)
    {
        ...
        {
            Toast.makeText(categoryRestaurant.this,"No more Deals To display",Toast.LENGTH_LONG).show();
            return;
        }
        count--;
        new GetTaggedDeal().execute();
    ...
    class GetTaggedDeal extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(categoryRestaurant.this);
        ...
        protected String doInBackground(String... args) {
            ...
            params.add(new BasicNameValuePair("category_id", "81"));
        ...
        protected void onPostExecute(String file_url) {
            ...
            try {
                        ...
                        v.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if (stat.getText().toString().equals("0")) {
                                    Toast.makeText(categoryRestaurant.this, "Local Business Deal", Toast.LENGTH_LONG).show();
                                    return;
                                }
                                TextView correcturl = (TextView) view.findViewById(R.id.correcturl);
                                Intent intent = new Intent(categoryRestaurant.this, DisplayDealUrl.class);
                ...
                {
                   // Toast.makeText(getApplicationContext(),"No deals",Toast.LENGTH_SHORT).show();
                }
            }catch (Exception e){
                Log.d("Mewtwo", "" + e);
            }
            ...
            if((curtot==null))
                Toast.makeText(categoryRestaurant.this,"No deals to display",Toast.LENGTH_LONG).show();
            else

                Toast.makeText(categoryRestaurant.this,"Showing "+curtot+" of "+tot+" deals",Toast.LENGTH_LONG).show();
        }
    }
